...
const Map = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <div className="w-1/3 p-6 flex flex-col items-center mt-10">
        ...
        <button
          ...
          className="mt-4 bg-gradient-to-r from-green-400 to-blue-400 text-white py-2 px-5 rounded-lg font-bold w-2/4 text-lg"
        >
          Search
        </button>
      </div>
